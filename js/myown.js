...
(function () {
  ...
  var telephoneField = document.getElementById ('contact-telephone');
  ...
  var hasError = function (field) {
    ...
    var telephoneTest = validRegExp.telephone.test (field.value);

    if (field.value === '' && field.name !== 'field-telephone') {
    ...
    if (
      ...
      return 'Ви ввели невірний номер телефону';
    }
  };
